...
alldata['5']=dict(nomor=5, nama="Manuel Neuer", posisi="kiper")
alldata['6']=dict(nomor=6, nama="Bruno Fernandes", posisi="gelandang tengah")
alldata['7']=dict(nomor=7, nama="Hugo Lloris", posisi="kiper")
alldata['8']=dict(nomor=8, nama="Erling Haaland", posisi="striker")
alldata['9']=dict(nomor=9, nama="Luka Modric", posisi="gelandang tengah")
alldata['10']=dict(nomor=10, nama="Karim Benzema", posisi="striker")
alldata['11']=dict(nomor=11, nama="Keylor Navas", posisi="kiper")
alldata['12']=dict(nomor=12, nama="Kylian Mbappe", posisi="striker")
alldata['13']=dict(nomor=13, nama="Leon Goretzka", posisi="gelandang tengah")
alldata['14']=dict(nomor=14, nama="Jan Oblak", posisi="kiper")
...
if __name__=='__main__':
    try:
        run_server(('0.0.0.0', 14000),is_secure=False) #Unsecured Connection
